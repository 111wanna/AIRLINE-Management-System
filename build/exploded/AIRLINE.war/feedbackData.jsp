<%-- 
    ...
    Created on : 14 Jul 2022, 9:03:21 am
    Author     : Acer
--%>
     ...
     <table width="100%">
         ...
         <tr height="500px" align="center"><td colspan="4">
                 <%
                     ...
                     c1=DriverManager.getConnection("jdbc:mysql://localhost:3306/airline","root","");
         ...
         <tr height="20px" align="center"><td colspan="4"><footer><h3>Airline Reservation
                         Copyright &copy; 2017</h3></footer></td>
         </tr>
     </table>
 </body>
</html>
