<%-- 
    Document   : TicketRiservation
    Created on : 14 Jul 2022, 8:51:50 am
    Author     : Acer
--%>
        ...
        <table width="100%">
            ...
            <tr height="500px" align="center"><td colspan="4">
                    <form action="Operation.jsp" method="post"><table>
                            <tr><td align="right"><h3 style="font-size: bold">Login Name : </h3></td>
                                <td> <input type="text" name="lgnm"></td></tr>
                            
                            <tr><td align="right"><h3 style="font-size: bold">Source : </h3></td><td>
                                    <select name="source">
                                        <option value="Sinagpore">Singapore</option>
                                        <option value="Malaysia">Malaysia</option>
                                        <option value="China">Thailand</option>
                                        <option value="India">India</option>
                                        <option value="Zimbobwe">Zimbobwe</option>
                                    </select></td> </tr>
                            <tr><td align="right"> <h3 style="font-size: bold">Destination :
                                    </h3></td><td> <select name="dest">
                            ...
                            <tr><td align="right"><h3 style="font-size: bold">Date :
                                    </h3></td><td><input type="date" name="date"/></td></tr>

                           <tr><td align="right"><h3 style="font-size: bold">Time :</h3></td>
